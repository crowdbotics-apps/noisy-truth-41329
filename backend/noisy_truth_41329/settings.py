"""
Django settings for noisy_truth_41329 project.
...
ROOT_URLCONF = 'noisy_truth_41329.urls'
...
WSGI_APPLICATION = 'noisy_truth_41329.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_truth_41329 API",
    "DESCRIPTION": "API documentation for noisy_truth_41329 App",
    "VERSION": "v1",
}
